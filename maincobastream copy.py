...
if uploaded_file is not None:
    ...
    with a1:
        st.markdown('<div class="metric-container">Ketersediaan Parkir:<br><span class="metric-label">{}</span></div>', unsafe_allow_html=True)
    with a2:
        st.markdown('<div class="metric-container">Slot:<br><span class="metric-label">{}</span></div>', unsafe_allow_html=True)
    with a3:
